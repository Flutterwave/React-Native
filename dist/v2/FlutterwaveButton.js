...
import { OptionsPropTypeBase } from '../FlutterwaveButton';
...
var FlutterwaveButton = /** @class */ (function (_super) {
    ...
    FlutterwaveButton.prototype.renderButton = function () {
        var _a = this.props, customButton = _a.customButton, style = _a.style, alignLeft = _a.alignLeft, children = _a.children;
        ...
        return (<DefaultButton alignLeft={alignLeft} style={style} isBusy={isPending && !link} disabled={isPending || showDialog ? true : false} onPress={this.handleInit} onSizeChange={this.handleButtonResize}>
          {children ? children : (<Image source={pryContent} resizeMode="contain" resizeMethod="resize" style={[styles.buttonContent, contentSizeStyle]} fadeDuration={0}/>)}
      </DefaultButton>);
    };
